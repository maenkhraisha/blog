...
import FeaturePosts from "../componenets/FeaturePosts";
        ...
        <div className='mt-4 flex flex-col gap-4'>
            ...
            <div className='flex items-center justify-between'>
                ...
                <Link to={"/write"} className='relative hidden md:block'>
                    ...
                    <button
                        className='absolute top-0 left-0 right-0 bottom-0 m-auto h-20 w-20  
                                    bg-blue-800 rounded-full flex items-center justify-center'>
                        <svg
